...
// Thanks to https://github.com/charmbracelet/glow/blob/master/ui/styles.go for this lovely color scheme
...
func newStyle(fg, bg lib.ColorPair, bold bool) styleFunc {
